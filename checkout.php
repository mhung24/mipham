...
<head>
    ...
    <style>
        ...
        .btn-order.banking-mode {
            background: #10b981;
            box-shadow: 0 5px 15px rgba(16, 185, 129, 0.3);
        }

        /* Màu xanh lá khi chuyển khoản */
        .btn-order.banking-mode:hover {
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" class="form-control" rows="2" required
                                    placeholder="Số nhà, ngõ, tên đường, phường/xã..."><?= htmlspecialchars($user['address'] ?? '') ?></textarea>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="payment-option active" id="opt-cod" onclick="selectPayment('cod')">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fw-bold d-flex align-items-center" for="cod">
                                        <img src="https://cdn-icons-png.flaticon.com/512/2331/2331941.png" width="24"
                                            class="me-3">
                            ...
                            <div class="payment-option" id="opt-banking" onclick="selectPayment('banking')">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fw-bold d-flex align-items-center" for="banking">
                                        <img src="https://cdn-icons-png.flaticon.com/512/3013/3013661.png" width="24"
                                            class="me-3">
                        ...
                        <div class="checkout-card">
                                ...
                                <?php foreach ($cart_items as $item): ?>
                                    <div class="summary-item">
                                        <div class="position-relative">
                                            <img src="<?= $item['thumbnail'] ?: 'https://via.placeholder.com/60' ?>"
                                                class="summary-img">
                                            <span
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-1">
                                                <small
                                                    class="text-muted"><?= number_format($item['price'], 0, ',', '.') ?>đ</small>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-group voucher-group">
                                    <input type="text" id="voucher_input" class="form-control"
                                        placeholder="Nhập mã giảm giá">
                                    <button style="background-color: #ccc; border: 1px solid #555;"
                                        class="btn btn-outline-secondary" type="button" onclick="checkVoucher()">Áp
                                        dụng</button>
                                </div>
                            ...
                            <div class="mt-4 pt-3 border-top">
                                ...
                                <div class="d-flex justify-content-between border-top pt-3 mb-2">
                                    ...
                                    <span class="fw-bold fs-3 text-danger" id="total_display"
                                        data-original="<?= $total_money ?>">
                                ...
                                <div id="qr-area" class="payment-qr-area">
                                    ...
                                    <div class="qr-wrapper">
                                        ...
                                        <div class="qr-expired-overlay" id="expired-overlay">
                                            <div style="font-weight: bold; color: #ef4444; margin-bottom: 5px;">Mã QR đã
                                                hết hạn</div>
                                            <button type="button" class="btn-refresh" onclick="resetTimer()">Lấy mã
                                                mới</button>
                                        </div>
                                    </div>
